...
public class UserDoHomeworkController {
     ...
     */
    @RequestMapping("/list")
    public Result list(@RequestBody  UserDoHomework userDoHomeworkVo) {
    ...
    public Result info(@PathVariable("id") Integer id) {
        UserDoHomework userDoHomework = userDoHomeworkService.getById(id);
     ...
     */
    @RequestMapping("/save")
    public Result save(@RequestBody UserDoHomework userDoHomeworkVo) {
        UserDoHomework userDoHomeworkEntity = new UserDoHomework();
    ...
    public Result update(@RequestBody UserDoHomework userDoHomework) {
