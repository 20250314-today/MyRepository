...
import com.example.service.VideoTotalService;
...
public class VideoTotalController {
    ...
    public Result save(@RequestParam Integer userId,
        ...
        videoTotalEntity.setCoverUrl("http://localhost:9999/file/imageFile/" + file.getOriginalFilename());
    ...
    public Result delete(@RequestBody VideoTotalEntity videoTotalVo) {
