<template>
  <div style="background-color: #cccccc;min-height: 1000px">
    <el-menu
...
<!--        <img :src="item" alt="" style="height:300px;width: 100%">-->
<!--      </el-carousel-item>-->
<!--    </el-carousel>-->
      <el-carousel height="300px">
    ...
    <div style="width:80%;margin:20px auto">
      <div style="font-size: 20px;border-left:5px solid #2fbd67;padding-left: 5px;height:30px;line-height: 30px">课程</div>
...
<!--           <img src="@/assets/img/女生打雪仗.png" alt="">-->
    ...
    <div style="width:80%;margin:20px auto">
      ...
      <div style="margin-top:20px">
       <div style="display: flex;margin-top:20px;grid-gap: 20px" v-for="item in data.introductionData">
         <div style="flex:1">
         ...
         <div style="flex:3">
           ...
           <div class="line" style="margin-top:10px;text-align: justify">{{item.description}}</div>
