...
var require_eventsource = __commonJS({
  "node_modules/eventsource-polyfill/dist/eventsource.js"(exports) {
    (function(global) {
      ...
      EventSource.prototype = {
        ...
        ondata: function() {
          var request2 = this._xhr;
          if (request2.isReady() && !request2.hasError()) {
            this.resetNoActivityTimer();
            if (this.readyState == this.CONNECTING) {
              this.readyState = this.OPEN;
              this.dispatchEvent("open", { type: "open" });
            }
            var buffer = request2.getBuffer();
      ...
      function isOldIE() {
        return window.XDomainRequest && (window.XMLHttpRequest && new XMLHttpRequest().responseType === void 0) ? true : false;
      }
...
var require_browserify_eventsource = __commonJS({
  "node_modules/eventsource-polyfill/dist/browserify-eventsource.js"(exports, module) {
    var PolyfillEventSource = require_eventsource().EventSource;
...
export default require_browserify_eventsource();
//# sourceMappingURL=eventsource-polyfill.js.map
